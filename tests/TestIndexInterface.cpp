...
TEST(BasicIndexInterfaceTest, Documents) {
    doc_t doc1{"a.com",   5,    1231,  2,
               5,         1231, 0.4,   0.5,
               1,         1231, 27.12, "Hi this is an example snippet",
               "ABC NEWS"};
    doc_t doc2{"b.com",  2,   20, 1,  4,    21,
               1.2,      1.3, 4,  10, 1.02, "This is snippet 2",
               "SDFDSF "};
    doc_t doc3{"c.com", 100, 5, 2,         100,       2,
               0.0,     0.2, 0, 231333333, 12.111111, "sdfasdfasdfsafsdfdf",
               "SDFSss"};
...
TEST(BasicIndexInterfaceTest, FloatingPointPrecision) {
    doc_t doc{"float.com", 5, 2, 4, 1, 1, 0.123456, 0.654321, 1, 23111, 0.12321, "", ""};
